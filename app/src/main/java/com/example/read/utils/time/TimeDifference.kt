...
class TimeDifference @Inject constructor() {
    ...
    fun getTimeDifference(startDate: Instant, endDate: Instant): String? {
        if (startDate.toEpochMilliseconds() != 0L) {
            var different = endDate.toEpochMilliseconds() - startDate.toEpochMilliseconds()
